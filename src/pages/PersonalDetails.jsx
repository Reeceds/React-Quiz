...
export default function PersonalDetails() {
    ...
    const [details, setDetails] = useState({firstName: '', lastName: '', email: '', alias: ''});
    ...
    useEffect(() => {
        setDetails({firstName: fName, lastName: lName, email: emailAddress, alias: alias});
    },[]);
            ...
            <Col lg={4}>
                <Form noValidate validated={validated} onSubmit={handleSubmit}>
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control type="text" placeholder="Enter quiz alias" minLength={3} maxLength={3} required value={details.alias || ''}  onChange={(e) => setDetails({...details, alias: (e.target.value.toUpperCase())})} />
